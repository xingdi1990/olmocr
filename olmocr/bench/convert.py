...
if __name__ == "__main__":
    ...
    available_methods = {
        ...
        "mineru_sglang_server": ("olmocr.bench.runners.run_mineru_vlm_sglang_server", "run_mineru_vlm_sglang_server"),
        "mineru_vllm_engine": ("olmocr.bench.runners.run_mineru_vlm_vllm_server", "run_mineru_vlm_vllm_server"),
