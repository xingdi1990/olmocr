...
where we may interpret $\widetilde { K } ^ { \mathrm { M M V } } = B ^ { 2 g _ { \mathrm { M M V } } \circ ( \hat { \lambda } \cdot R ) }$ as the cumulative maximal local squared MHR. Using the conversion be we en the (monotone) Hansen and the (monotone) Sharpe ratio, we also obtain  
...
<html><body><table><tr><td>W1</td><td>W2</td><td>W3</td><td>W4</td></tr><tr><td>P[{w}]</td><td>0.2 0.6</td><td>0.1</td><td>0.1</td></tr><tr><td>△R1(ω)</td><td>-0.5 0.5</td><td>1</td><td>1.2</td></tr><tr><td>△R²(w)</td><td>-0.5 0.5</td><td>1.2</td><td>1</td></tr></table></body></html>  
