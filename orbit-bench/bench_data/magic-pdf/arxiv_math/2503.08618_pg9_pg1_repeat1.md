...
Corollary 4.2. Let $p \in \mathbb { P } _ { n }$ with $a _ { n _ { l } } = \alpha _ { n _ { l } } + \beta _ { n _ { l } } i$ such that no two adjacent coefficients $a _ { n _ { j } } ^ { \prime } s$ are equal, i.e. $a _ { n _ { j } } \ne a _ { n _ { j + 1 } } , j = 0 , 1 , 2 , \cdot \cdot \cdot , k$ and $\alpha _ { n _ { 0 } } \leq \alpha _ { n _ { 1 } } \leq$ $\cdots \le \alpha _ { n _ { k } }$ and for all ${ \beta _ { n } } _ { j }$ , $0 \leq j \leq n$ . Further let $M _ { n _ { j } } , 1 \le j \le k$ with $M$ as defined in Theorem 2.1. Then all the zeros lie in  
...
Corollary 4.3. Let $\begin{array} { r } { p ( q ) = \sum _ { \nu = 0 } ^ { n } q ^ { n _ { j } } a _ { n _ { j } } } \end{array}$ such that no two adjacent coefficients $a _ { n _ { j } } ^ { \prime } s$ are equal, i.e. $a _ { n _ { j } } \ne a _ { n _ { j + 1 } } , j = 0 , 1 , 2 , \cdot \cdot \cdot , k$ and $\alpha _ { n _ { 0 } } \leq \alpha _ { n _ { 1 } } \leq \cdot \cdot \cdot \leq \alpha _ { n _ { k } }$ . Further let $M _ { n _ { j } } , 1 \leq j \leq k$ with $M$ as defined in Theorem 2.1. Then all the zeros of $p ( q )$ lie in  

$$
\vert q \vert \leq \frac { M } { \vert a _ { n } \vert } ( \alpha _ { n } - \alpha _ { 0 } + \vert \alpha _ { 0 } \vert ) .
$$  
