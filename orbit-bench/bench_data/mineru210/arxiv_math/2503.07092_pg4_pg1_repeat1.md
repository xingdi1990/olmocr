define the set $S \subseteq \{ 1 , 2 , \dotsc , n \} \times \{ 1 , 2 , \dotsc , f + g \}$ , and assume the entry hAtrue Btruei is given for all $( i , j ) \in S$ . The set of systems compatible with the prior knowledge is given by
